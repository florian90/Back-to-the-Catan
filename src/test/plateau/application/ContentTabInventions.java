...
public class ContentTabInventions extends GridPane
{
	...
	public ContentTabInventions()
	{
		...
		Label detailsTrain = new Label("D�tails");
		Label detailsRadio = new Label("D�tails");
		Label detailsConvecteur = new Label("D�tails");
		Label detailsHoverboard = new Label("D�tails");
		...
		detailsRadio.setOnMouseClicked(new EventHandler<MouseEvent>()
		{
			...
			{
				stack.getChildren().removeAll(stack.getChildren());
				stack.getChildren().add(new DetailInvention("Radio", "2xAntenne + 4xHaut-Parleur + 3xM�tal", "textures/radio.jpg", "Ceci est une radio"));
		...
		detailsConvecteur.setOnMouseClicked(new EventHandler<MouseEvent>()
		{
			...
			{
				stack.getChildren().removeAll(stack.getChildren());
				stack.getChildren().add(new DetailInvention("Convecteur Temporel", "3xMorceau de Sch�ma + 6xPlutonium", "textures/convecteur.gif", "Ceci est un convecteur temporel"));
		...
		detailsHoverboard.setOnMouseClicked(new EventHandler<MouseEvent>()
		{
			...
			{
				stack.getChildren().removeAll(stack.getChildren());
				stack.getChildren().add(new DetailInvention("Hoverboard", "4xVentilateur + 2xAimant + 3xM�tal", "textures/hoverboard.jpg", "Ceci est un hoverboard"));
